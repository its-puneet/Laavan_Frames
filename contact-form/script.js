...
form.onsubmit = (e) => {
    ...
    statusmessage.style.color = "#ffffff"; // Set message color
    ...
    setTimeout(() => {
        ...
        if (!email || !message) {
            ...
            statusmessage.style.color = "white"; // Error color
            ...
            statusmessage.style.color = "white"; // Change text color for success
